...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///project.db' # URI - идентификатор
app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False  # Отключение предупреждений
# Строчки из песни, используемые как SECRET_KEY
